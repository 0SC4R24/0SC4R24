...
- 🎨 Specialized in OpenGL, graphics pipelines, and rendering architectures

- ⚙️ Experienced with C++, GLSL, Unity, Unreal, and low-level systems
  
- 🛰️ Love building simulations, shaders, and debugging the weirdest artifacts
  
- 📚 Always exploring advanced rendering techniques & GPU optimization tricks
